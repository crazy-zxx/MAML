...
path = '/datasets/data/nnUNet_preprocessed/Task521_BraTS2021/nnUNetPlansv2.1_plans_3D.pkl'
f = open(path, 'rb')
plans = pickle.load(f)
...
save_pickle(plans, join("/datasets/data/nnUNet_preprocessed/Task521_BraTS2021/", 'nnUNetPlansv2.1_bs1_plans_3D.pkl'))
